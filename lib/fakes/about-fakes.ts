export const aboutData = {
  ...
  answer: {
    title: "THE ANSWER",
    description: "Limb reconstruction is a field of orthopaedic surgery that is at the cutting edge of the treatment of limb deformities, fracture-related infection and poorly healing fractures. The Kijabe Limb Reconstruction Unit exists to equalise access to limb reconstruction surgery by providing world-class, compassionate specialist surgical care to patients whilst serving as a first-of-a-kind training centre for surgical trainees and fellows nationally and regionally. The goal of this unit is to do this at little or no cost to the underprivileged."
  },
  vision: {
    title: "THE VISION",
  ...
  hospital: {
    title: "the hospital",
    description: "Kijabe Hospital is a leading medical facility in East Africa, renowned for its excellence in surgical care and medical education. The hospital serves as a beacon of hope for patients across the region, providing world-class medical services regardless of their ability to pay. Our state-of-the-art facilities and dedicated medical staff ensure that every patient receives the highest quality care possible."
  },
  need: {
    title: "the need for reconstruction surgery",
    description: "Reconstruction surgery is essential for treating complex injuries, congenital deformities, and complications from trauma. Without proper surgical intervention, patients face lifelong disability, chronic pain, and social isolation. Our mission is to ensure that no patient is denied access to life-changing surgical care due to financial constraints or geographical barriers."
  }
};
