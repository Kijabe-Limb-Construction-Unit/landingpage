      ...
      <div className="bg-[#4FB29E] py-4">
        <div className="max-w-5xl mx-auto flex justify-center">
          <div className="w-full text-white md:pl-20 lg:pl-0">
            ...
            <div className="mb-2">
              <p className="font-bold text-[#003683] mb-2 flex justify-center tracking-wider text-lg md:text-2xl lg:text-5xl sm:justify-start sm:ml-25 sm:pl-5">KIJABE LIMB RECONSTRUCTION UNIT</p>
