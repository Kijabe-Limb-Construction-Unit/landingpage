    ...
    <section className="flex flex-col justify-center items-center py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center border-b-3 border-[#003683] mb-12">
          ...
          <div className="text-[#003683] space-y-4 sm:space-y-6 px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-6 sm:py-8 lg:py-12">
            <div className="w-full">
              ...
              <div className="mt-2">
                <span className="font-bold text-sm xs:text-base sm:text-lg md:text-lg lg:text-xl xl:text-2xl">DR. MBONISI MALABA</span>
              </div>
            </div>

            <div className="space-y-4">
              <p className="font-bold text-base sm:text-lg md:text-2xl lg:text-2xl">{aboutData.surgeon.role}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full mx-auto px-0 sm:px-6 lg:px-8">
        ...
        <Image
          ...
          className="float-right ml-4 sm:ml-8 md:ml-12 lg:ml-16 xl:ml-20 md:mr-8 lg:mr-12 xl:mr-16 mb-6 mt-0 hidden md:block w-[40%] sm:w-[42%] md:w-[45%] max-h-[550px]"
        />
        ...
        <Image
          ...
          height={200}
          alt="Dr. Malaba with his family - a happy family of five standing together outdoors"
          className="float-none ml-0 mr-0 mb-6 mt-0 w-full md:hidden max-h-[550px] object-cover"
        />

        {/* Text Content - wraps around the image */}
        <div className="text-blue-900 leading-relaxed mt-0 text-xs sm:text-sm md:text-base lg:text-lg px-4 sm:px-0">
          <p className="pr-0 sm:pr-4 md:pr-8 lg:pr-12 xl:pr-16 text-justify hyphens-auto">
            ...
            <span className="font-light"> (</span>COSECSA<span className="font-light">.)</span> During his surgical training, he was awarded a number
            of prizes including the medal for best<span className="font-light">-</span>performing candidate in the
            COSECSA Orthopaedic <span className="font-light">(</span>2017<span className="font-light">)</span> and Paediatric Orthopaedic <span className="font-light">(</span>2021<span className="font-light">) </span>
            Examinations as well at the prestigious{" "}
            <span className="font-semibold">Gerald O´Sullivan Medal</span><span className="font-bold"> (2017)</span>{" "}
            ...
            <span className="font-normal"> (</span>one of the busiest trauma centres in Europe<span className="font-light">)</span> and the
            <span className="font-bold">
              Royal National Orthopaedic Hospital
            </span>
            <span> <span className="font-light">-</span> a centre of excellence north of London. He </span>
