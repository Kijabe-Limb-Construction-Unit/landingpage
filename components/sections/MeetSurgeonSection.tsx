      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-0">
        ...
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Image
            ...
            height={200}
            alt="Dr. Malaba with his family - a happy family of five standing together outdoors"
            className="float-right ml-4 mr-0 mb-6 mt-0 w-full md:hidden max-h-[550px]"
          />

          {/* Text Content - wraps around the image */}
          <div className="text-blue-900 leading-relaxed mt-0 text-xs sm:text-sm md:text-base lg:text-lg">
