...
const Footer = () => {
  return (
    <footer className="w-full">
      ...
      <div className="bg-white border-t-[5.4px] border-[#083783]">
        ...
        <div className="bg-white px-8 pt-1 md:pt-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right text-[10px] sm:text-base md:text-lg text-[#003683]">
              <span className="font-light">Restoring limbs |</span>
              <span className="font-bold ml-2">Rebuilding lives.</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Footer Section */}
      <div className="bg-[#083783] text-white px-8 py-8">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="flex justify-center space-x-4 mb-6">
            {/* Facebook */}
            <a href="#" className="w-10 h-10 bg-white rounded-sm flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="Facebook">
              <svg className="w-5 h-5 text-[#083783]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
              </svg>
            </a>

            {/* Instagram */}
            <a href="#" className="w-10 h-10 bg-white rounded-sm flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="Instagram">
              <svg className="w-5 h-5 text-[#083783]" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* LinkedIn */}
            <a href="#" className="w-10 h-10 bg-white rounded-sm flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="LinkedIn">
              <svg className="w-5 h-5 text-[#083783]" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* YouTube */}
            <a href="#" className="w-10 h-10 bg-white rounded-sm flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="YouTube">
              <svg className="w-5 h-5 text-[#083783]" fill="currentColor" viewBox="0 0 24 24">
